...
public:
    ...
    wxString GetShortDescription() override {
        return "ETA to destination or selected route waypoint";
    }
    wxString GetLongDescription() override {
        return "Calculates ETA using live SOG or a manually entered speed.";
    }
...
private:
    ...
    static wxString FormatEtaUtc(double hours);
    ...
    wxStaticText* m_destDistance = nullptr;
    wxStaticText* m_destTtg = nullptr;
    wxStaticText* m_destEtaUtc = nullptr;
    wxStaticText* m_destEtaLocal = nullptr;

    wxStaticText* m_wpDistance = nullptr;
    wxStaticText* m_wpTtg = nullptr;
    wxStaticText* m_wpEtaUtc = nullptr;
    wxStaticText* m_wpEtaLocal = nullptr;
